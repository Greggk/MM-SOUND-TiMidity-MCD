...
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) \
	$(LISP)config.h.in interface.h.in
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/common.makefile.in \
	$(srcdir)/config.h.in $(srcdir)/interface.h.in AUTHORS COPYING \
...
X_PRE_LIBS = 
a_so_libs = 
abs_builddir = U:/CWMM_Workspace/Timidity/MM-SOUND-TiMidity-MCD
abs_srcdir = U:/CWMM_Workspace/Timidity/MM-SOUND-TiMidity-MCD
abs_top_builddir = U:/CWMM_Workspace/Timidity/MM-SOUND-TiMidity-MCD
abs_top_srcdir = U:/CWMM_Workspace/Timidity/MM-SOUND-TiMidity-MCD
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} U:/CWMM_Workspace/Timidity/MM-SOUND-TiMidity-MCD/install-sh
k_so_libs = 
